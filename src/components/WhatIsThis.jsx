function WhatIsThis() {
  return (
    <section id="vad-ar-det" className="max-w-[1400px] mx-auto px-6 md:px-12 py-32 pt-32 md:pt-40">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div className="group bg-white rounded-3xl p-8 shadow-md border border-slate-100 hover:shadow-2xl hover:border-green-200 hover:-translate-y-2 transition-all duration-300">
          ...
          <p className="text-slate-600 leading-relaxed">
            Provet täcker matematik (algebra, geometri, funktioner) och fysik (mekanik, elektricitet, våglära). Totalt 4 timmar.
          </p>
        </div>
