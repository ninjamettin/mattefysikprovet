...
const LoginForm = React.memo(({ email, setEmail, password, setPassword, setIsPasswordFocused, handleGoogleLogin, handleSubmit }) => {
  return (
        ...
        <form onSubmit={handleSubmit} className="login-form">
          <div className="form-group">
            ...
            <input
              ...
              placeholder="din.email@exempel.se" required
            />
          </div>
...
const Login = () => {
  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      login({ email: userInfo.email, name: userInfo.name, method: 'google' }, userInfo.picture);
      navigate('/dashboard');
    }
  });
